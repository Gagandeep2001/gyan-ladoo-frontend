...
const App = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setPosts([
        { id: '1', title: 'Pinjar', excerpt: 'A poignant novel set during the partition of India...', author: { node: { name: 'Amrita Pritam' } }, slug: 'pinjar' },
        { id: '2', title: 'Chitta Lahu', excerpt: 'A gripping tale of social reform...', author: { node: { name: 'Nanak Singh' } }, slug: 'chitta-lahu' },
        { id: '3', title: 'Luna', excerpt: 'A modern retelling of the legend of Puran Bhagat...', author: { node: { name: 'Shiv Kumar Batalvi' } }, slug: 'luna' }
      ]);
      setCategories([
  ...
  useEffect(() => { 
    ...
    link.href = "https://fonts.googleapis.com/css2?family=Newsreader:opsz,wght@6..72,200..800&family=Noto+Sans:wght@400;500;700&display=swap";
    link.rel = "stylesheet";
  ...
  return (
    <div className="bg-[#f8f6f6] text-[#181113] font-serif antialiased overflow-x-hidden min-h-screen flex flex-col">
      {/* Top Navigation */}
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div className="flex flex-col gap-6 text-left">
                ...
                <h1 className="font-sans text-5xl font-black leading-[1.1] tracking-tight text-[#181113] sm:text-6xl lg:text-7xl">
                  Explore the Soul <br/><span className="text-[#cf1754] italic">of Punjab</span>
                </h1>
                <p className="max-w-xl text-lg text-[#88636f] sm:text-xl leading-relaxed">
                ...
                <div className="absolute bottom-10 left-10 right-10 rounded-xl bg-white/90 p-6 backdrop-blur shadow-xl border border-white/20">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm italic text-[#88636f]">{posts[0]?.title || "Classic Literature"}</p>
        ...
        <section className="py-16 px-4 sm:px-10 bg-white">
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 text-center max-w-2xl mx-auto">
              ...
              <p className="mt-4 text-lg text-[#88636f]">Navigate through the foundational forms of Punjabi literature, curated for your learning journey.</p>
            </div>
              ...
              {categories.slice(0, 4).map((cat, idx) => (
                <a key={cat.slug} className="group relative overflow-hidden rounded-xl bg-[#f8f6f6] p-1 transition-all hover:shadow-xl hover:-translate-y-1" href={`https://gyanladoo.com/category/${cat.slug}`}>
                  ...
                  <div className="p-5">
                    ...
                    <p className="mt-2 text-sm text-[#88636f] line-clamp-2">{cat.count} curated articles and summaries.</p>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
              <div>
                ...
                <p className="mt-2 text-[#88636f]">Handpicked selections to start your reading journey.</p>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="relative overflow-hidden rounded-2xl bg-[#cf1754] text-white p-8 lg:p-12 flex flex-col justify-center min-h-[400px]">
                ...
                <div className="relative z-10 max-w-lg">
                  ...
                  <h3 className="font-sans text-4xl font-bold leading-tight sm:text-5xl">{posts[0]?.title}</h3>
                  <p className="mt-2 text-xl font-medium text-white/90">by {posts[0]?.author?.node?.name}</p>
                  <p className="mt-6 text-lg text-white/80 leading-relaxed line-clamp-3">{cleanExcerpt(posts[0]?.excerpt)}</p>
                  <div className="mt-8">
                  ...
                  <div key={post.id} className="flex flex-col sm:flex-row gap-4 rounded-xl border border-[#e5dce0] bg-white p-4 transition-colors hover:border-[#cf1754]/30 group">
                    ...
                    <div className="flex flex-1 flex-col justify-between py-1">
                      <div>
                        ...
                        <p className="text-sm font-medium text-[#88636f]">by {post.author?.node?.name}</p>
                        <p className="mt-2 text-sm text-[#88636f] line-clamp-2">{cleanExcerpt(post.excerpt)}</p>
                      </div>
        ...
        <section className="border-t border-[#e5dce0] bg-white px-4 sm:px-10 py-16">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-[#88636f]">Get the latest stories, poems, and analysis delivered straight to your inbox. Perfect for students preparing for exams.</p>
